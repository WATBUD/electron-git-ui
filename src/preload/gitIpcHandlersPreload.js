...
contextBridge.exposeInMainWorld('git', {
  ...
  stashPush: (message, files) => ipcRenderer.invoke('git:stashPush', message, files),
  ...
  stashRename: (stashIndex, newMessage) => ipcRenderer.invoke('git:stashRename', stashIndex, newMessage),
