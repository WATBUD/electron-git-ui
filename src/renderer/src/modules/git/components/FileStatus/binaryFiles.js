...
export const BINARY_EXTENSIONS = new Set([
  ...
  'dex', 'class', 'o', 'obj', 'a', 'lib', 'so', 'dylib', 'dll', 'exe', 'pyc', 'pyo',
  // Archives / packages
  'zip', 'tar', 'gz', 'tgz', 'bz2', '7z', 'rar', 'jar', 'war', 'ear', 'apk', 'aab', 'ipa', 'aar',
  // Images
  'png', 'jpg', 'jpeg', 'gif', 'bmp', 'ico', 'webp', 'tif', 'tiff', 'psd', 'ai', 'heic', 'avif',
  // Audio / video
  'mp3', 'mp4', 'avi', 'mov', 'mkv', 'wav', 'flac', 'ogg', 'webm', 'm4a', 'm4v', 'aac',
  // Documents
  'pdf', 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx',
  // Fonts
  'ttf', 'otf', 'woff', 'woff2', 'eot',
  // Misc
  'bin', 'dat', 'db', 'sqlite', 'sqlite3', 'keystore', 'jks', 'p12', 'pfx', 'crt', 'cer'
])

// git diff markers that indicate a binary blob (no readable text diff).
const BINARY_DIFF_MARKERS = [
  /^Binary files .+ differ\s*$/m,
  /^GIT binary patch\s*$/m
]
